...
\author[Team Qarabağ Zəfəri]{
    \textbf{Avaz Asgarov} \and \textbf{Kazim Mammadli} \and \textbf{Gulnaz Babazade} \\[0.1cm]
    \textbf{Hasan Mammadov} \and \textbf{Nijat Alaskarli}
}
        ...
        \begin{column}{0.48\textwidth}
            \begin{techblock}{Engineering Team: Qarabağ Zəfəri}
                ...
                \begin{itemize}\setlength{\itemsep}{4pt}
                    ...
                    \item \textbf{Gulnaz Babazade}
                    \item \textbf{Hasan Mammadov}
                    \item \textbf{Nijat Alaskarli}
                \end{itemize}
            \end{techblock}
        \end{column}
...
% ------------------------------------------------------------------------------
\input{sections/01_dataset.tex}
\input{sections/02_experiments.tex}
\input{sections/03_tinyml_hardware.tex}
\input{sections/04_mobile_app.tex}
